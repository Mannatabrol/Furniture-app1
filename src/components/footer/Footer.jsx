    ...
    <>
      <footer className="container text-center text-lg-start bg-body-tertiary text-muted mt-5">
        <SocialMediaSection className="d-flex justify-content-center justify-content-lg-between px-4 py-3 border-bottom">
          ...
          <div>
            <SocialMediaLink href="https://www.facebook.com/login/" className="me-4 text-reset">
              <FontAwesomeIcon icon={faFacebookF} />
            </SocialMediaLink>
            <SocialMediaLink href="https://x.com/i/flow/login" className="me-4 text-reset">
              <FontAwesomeIcon icon={faTwitter} />
            </SocialMediaLink>
            <SocialMediaLink href="https://www.linkedin.com/feed/" className="me-4 text-reset">
              <FontAwesomeIcon icon={faLinkedin} />
            </SocialMediaLink>
            <SocialMediaLink href="https://www.instagram.com/accounts/login/?hl=en" className="me-4 text-reset">
              <FontAwesomeIcon icon={faInstagram} />
            </SocialMediaLink>
            <SocialMediaLink href="https://github.com/login" className="me-4 text-reset">
        ...
        <div className="container text-center text-md-start mt-3">
          <div className="row">
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-4">
              <FooterHeading className="text-uppercase fw-bold mb-2">Services</FooterHeading>
              <p>
                <FooterLink
                  to="/faq"
                  className="text-reset text-decoration-none"
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mt-4 text-center text-md-start">
              ...
              <p className="d-flex align-items-center justify-content-center justify-content-md-start">
                <FontAwesomeIcon
                  ...
                  style={{ fontSize: '17px' }}
                />
                <small>kourjagjot01@gmail.com</small>
              </p>
              <p className="d-flex align-items-center justify-content-center justify-content-md-start">
                <FontAwesomeIcon
                  icon={faPhone}
